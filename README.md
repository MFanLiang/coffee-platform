...
🚀🚀🚀 coffee-platform，基于 React18、React-Router v6、React-Hooks、Redux && Redux-Toolkit、TypeScript、Vite2、Ant-Design 开源的一套后台管理框架。
...
├─ public                 # 静态资源文件（忽略打包）
├─ conf                   # vite 配置
│  ├─ vite.config.ts      # vite 主要配置文件
│  ├─ vite.config.base.ts # vite 公共配置文件
│  ├─ vite.config.prod.ts # vite 生产配置文件
│  ├─ vite.config.deve.ts # vite 开发配置文件
├─ src
│  ├─ api                 # API 接口管理
│  ├─ assets              # 静态资源文件
│  ├─ components          # 全局组件
